...
<head>
    <title>Non-Stop Healthcare : Register</title>
                                    ...
                                    <form class="appointment-form" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-6">
                                                ...
                                                <input type="password" class="wp-form-control wpcf7-text" placeholder="Confirm Password" name="repwd" value="<?= $repwd ?>" required>
                                            </div>
                                            <div class="col-lg-2 col-md-2"></div>
                                        </div>
                                        <div class="row">
